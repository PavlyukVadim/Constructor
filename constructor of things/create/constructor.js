...
$('.clean').bind('click', function() {
  var layersList = document.getElementsByClassName('layers-list')[0],
      layers = layersList.getElementsByClassName('layer');
...
$('.item').bind('click', function(e) {
  ...
  if(activeProduct == 'Case') {
    createCase();
  } else if(activeProduct == 'T-Shirt') {
    createTshirt();
  } else if(activeProduct == 'Tank Top') {
    createTankTop();
  } else if(activeProduct == 'Pillow') {
    createPillow();
  } else if(activeProduct == 'Poster') {
    createPoster();
  } else if(activeProduct == 'Puzzle') {
    createPuzzle();
  } else if(activeProduct == 'Ceramic Mug') {
    createCeramicMug();
  }
});
